...
(
    ...
    TEMPERATURE   double                               default 0.5     null,
    F_PENALTY     double                               default 0.5     null,
    P_PENALTY     double                               default 0       null,
...
(
    ...
    REG_DT       timestamp                                null,
    UPD_ID       varchar(50) collate utf8_unicode_ci      null,
    UPD_DT       timestamp                                null,
    CHAT_CONT    text collate utf8mb4_unicode_ci          null,
    REG_ID       varchar(50) collate utf8_unicode_ci      null comment '업데이트 ID',
...
(
    CHAT_LEARN_NO int auto_increment comment '학습용 채팅 일련번호'
        primary key,
    CHAT_CONT     tinytext collate utf8_unicode_ci    null comment '채팅 내용',
    REG_ID        varchar(50) collate utf8_unicode_ci null comment '업데이트 ID',
    REG_DT        timestamp                           null,
    UPD_ID        varchar(50) collate utf8_unicode_ci null,
    UPD_DT        timestamp                           null,
